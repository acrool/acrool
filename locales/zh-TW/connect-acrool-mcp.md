...
- [連線資訊](#連線資訊)
- [認證方式](#認證方式)
- [連接 Claude Desktop（OAuth）](#連接-claude-desktopoauth)
- [連接 Claude Code（CLI）](#連接-claude-codecli)
- [連接 OpenAI Codex CLI（v0.137.0+）](#連接-openai-codex-cliv01370)
- [可用工具與所需權限（scope）](#可用工具與所需權限scope)
- [疑難排解](#疑難排解)
