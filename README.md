...
This repository provides Acrool Desktop App downloads, release references, MCP setup guidance, and bug report instructions.

Localized documentation: [繁體中文](locales/zh-TW/README.md)
...
Acrool provides an MCP (Model Context Protocol) server so MCP-compatible AI assistants such as Claude Desktop, Claude Code (CLI), and OpenAI Codex CLI can read and update your tasks directly inside a conversation.

For full setup steps, see: [Connect Acrool with MCP-Compatible AI Assistants](connect-acrool-mcp.md).
